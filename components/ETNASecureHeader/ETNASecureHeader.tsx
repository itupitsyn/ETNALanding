  ...
  return (
    <header
      ...
      className={cn(
        ...
        'relative container flex h-svh max-h-231.25 cursor-default flex-col items-start justify-end bg-[url(/images/secure-bg.webp)] bg-size-[850px_auto] bg-position-[50%_55%] bg-no-repeat py-8',
