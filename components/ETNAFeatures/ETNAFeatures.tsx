      ...
      <div className="xs:gap-3 flex justify-between gap-1.5 lg:gap-5">
        {features.map((item, idx, list) => (
          <Fragment key={item.id}>
            <div className="xs:border-t xs:border-b xs:gap-11 xs:border-solid xs:border-border xs:w-62 xs:min-h-61.5 xs:px-3 xs:py-4 flex min-h-85 w-90 flex-none grow flex-col gap-22.5 px-4 py-5.5 lg:min-h-110 lg:w-111.75 lg:gap-27.5 lg:px-5.5 lg:py-7">
