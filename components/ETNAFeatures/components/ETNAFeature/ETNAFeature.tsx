...
export const ETNAFeature: FC<ETNAFeatureProps> = ({ header, text, className, textClassName, delayMultiplier = 0 }) => {
  ...
  return (
    <div
      className={cn(
        'xs:border-0 xs:gap-11 xs:border-solid xs:border-border xs:w-62 xs:min-h-61.5 xs:px-3 xs:py-4 flex min-h-85 w-90 flex-none grow flex-col gap-22.5 border-t border-b px-4 py-5.5 lg:min-h-110 lg:w-111.75 lg:gap-27.5 lg:px-5.5 lg:py-7',
        className,
      )}
    >
      <h2
