...
export const Navigation: FC = () => {
  return (
    <nav className="text-lighter xs:top-3 absolute top-5 left-0 flex w-screen justify-between gap-2 px-5 py-3 font-light tracking-tighter lg:top-6 lg:text-xl">
