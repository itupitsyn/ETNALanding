  ...
  return (
    <div
      className={cn(
        ...
        'relative container flex h-svh max-h-231.25 flex-col items-start justify-end bg-[radial-gradient(48.22%_119.67%_at_-10.36%_78.1%,rgba(135,168,209,0.3)_0%,rgba(0,0,0,0)_100%),linear-gradient(0deg,#00081D,#00081D)] bg-no-repeat py-8',
    ...
    >
      ...
      <div className="font-pt-root xs:text-[70px] absolute top-1/2 left-1/2 flex -translate-1/2 gap-4.5 text-[58px] leading-none tracking-tight lg:text-[96px]">
