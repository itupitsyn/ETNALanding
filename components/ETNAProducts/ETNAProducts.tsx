...
export const ETNAProducts: FC = () => {
  const commonCardClass =
    'xs:aspect-auto xs:h-[391px] xs:px-2.5 xs:py-3 xs:grow relative flex aspect-square flex-col items-start justify-end px-6 py-5.5 overflow-hidden lg:px-4.5 lg:py-5.5 lg:h-[694px]';

  return (
    <div className="xs:flex-row container flex flex-col gap-2.5 py-8">
      <div
        className={cn(
          'xs:bg-size-[2000px_auto] bg-[url(/movemate-bg.png)] bg-size-[1500px_auto] bg-position-[53%_40%] bg-no-repeat',
          commonCardClass,
        )}
      >
      ...
      <div
        className={cn(
          'xs:bg-center bg-black bg-[url(/secure-bg.png)] bg-size-[700px_auto] bg-top bg-no-repeat',
          commonCardClass,
        )}
      >
