...
export const Input: FC<DetailedHTMLProps<InputHTMLAttributes<HTMLInputElement>, HTMLInputElement>> = ({
  ...
  return (
    <input
      className={cn(
        'border-input-border text-input-border placeholder:text-input-border border-b border-solid px-1 py-3.5 leading-4.5 font-light tracking-tight transition-colors outline-none lg:text-xl lg:leading-5.5',
